...
class Client {
	...
	let fidoParser = Locator.fidoParser
...
// MARK: - Login
extension Client {
	func loginWithNumber(number: String, password: String, completion: ((Bool, [String: String]?) -> Void)? = nil) {
		switch currentPage {
		case .Login:
...
extension Client {
	...
	func showViewUsgaeForSection(section: String, completion: ((Bool, [String: String]?) -> Void)? = nil) {
		switch currentPage {
