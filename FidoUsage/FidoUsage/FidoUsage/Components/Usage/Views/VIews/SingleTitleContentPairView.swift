...
class SingleTitleContentPairView: UIView {
	...
	var horizontalSpacingEqualConstraint: NSLayoutConstraint?
	var horizontalSpacingGreaterThanConstraint: NSLayoutConstraint?
